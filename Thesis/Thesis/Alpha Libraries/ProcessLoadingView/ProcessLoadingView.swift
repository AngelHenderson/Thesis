...
public class ProcessLoadingView: UIView
{
    ...
    func animatePath(of stroke:Stroke?, completed: (()->())?)
    {
        ...
        stroke.shapeLayer.lineJoin = CAShapeLayerLineJoin.round
    ...
    private func preparation()
    {
        ...
        curvesLayerParent.backgroundColor = UIColor.clear.cgColor
        ...
        if let center = self.myCenter {
            textLayerParent.position = center
        }
