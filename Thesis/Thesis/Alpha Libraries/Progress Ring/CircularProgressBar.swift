...
public class CircularProgressBar: CALayer {
    ...
    public var progress: CGFloat = 0 {
        didSet {
            progressLabel.text = "\(progress.int)%"
    ...
    public init(radius: CGFloat, position: CGPoint, innerTrackColor: UIColor, outerTrackColor: UIColor, lineWidth: CGFloat) {
        ...
        let size = CGSize(width: radius+10, height: radius)
    ...
    public init(radius: CGFloat, position: CGPoint, innerTrackColor: UIColor, outerTrackColor: UIColor, lineWidth: CGFloat, withComplete: Bool) {
        super.init()
