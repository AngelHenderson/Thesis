...
class SVUploader: UIView {
    ...
    var SVUborderColor = UIColor(red:0.55, green:0.55, blue:0.55, alpha:1.0) {
        didSet { circleBorderLayer.strokeColor = SVUborderColor.cgColor }
    }
    
    /** The width of the border */
    var SVUborderWidth: CGFloat = 0 {
        didSet { circleBorderLayer.lineWidth = SVUborderWidth }
    }
    ...
    func setup() {
        ...
        circleBorderLayer.strokeColor = SVUborderColor.cgColor
    ...
    override func layoutSubviews() {
        ...
        containerView.frame.SVUcenter = containerView.superview!.bounds.center
        ...
        endImageView.frame.SVUcenter = endImageView.superview!.bounds.center
