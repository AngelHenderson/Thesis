...
//  Alpha
//
//  Created by Angel Henderson on 4/10/19.
...
class PlayPauseView: UIView {
    ...
    lazy var playLayer: CAShapeLayer = {
        ...
        playLayer.fillColor = UIColor.black.cgColor
        return playLayer
    }()
    
    lazy var pauseLayer: CAShapeLayer = {
        let pauseLayer = CAShapeLayer()
        pauseLayer.fillColor = UIColor.black.cgColor
        return pauseLayer
    }()
    ...
    func animate() {
        let playDuration: Double = state == .play ? 0.25 : 0.25
