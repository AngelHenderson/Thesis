...
public class FloatingPanelSurfaceView: UIView {
    ...
    public var fpcornerRadius: CGFloat {
    ...
    public var fpshadowColor: UIColor = .black  { didSet { setNeedsLayout() } }

    /// The offset (in points) of the surface shadow.
    public var fpshadowOffset: CGSize = CGSize(width: 0.0, height: 1.0)  { didSet { setNeedsLayout() } }

    /// The opacity of the surface shadow.
    public var fpshadowOpacity: Float = 0.2 { didSet { setNeedsLayout() } }

    /// The blur radius (in points) used to render the surface shadow.
    public var fpshadowRadius: CGFloat = 3  { didSet { setNeedsLayout() } }

    /// The width of the surface border.
    public var fpborderColor: UIColor?  { didSet { setNeedsLayout() } }

    /// The color of the surface border.
    public var fpborderWidth: CGFloat = 0.0  { didSet { setNeedsLayout() } }
    ...
    private func updateShadow() {
        if shadowHidden == false {
            if #available(iOS 11, *) {
                ...
                layer.shadowColor = fpshadowColor.cgColor
                layer.shadowOffset = fpshadowOffset
                layer.shadowOpacity = fpshadowOpacity
                layer.shadowRadius = fpshadowRadius
            } else {
    ...
    private func updateBorder() {
        containerView.layer.borderColor = fpborderColor?.cgColor
        containerView.layer.borderWidth = fpborderWidth
    }
