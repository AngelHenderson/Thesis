...
@IBDesignable open class YoshikoTextField: TextFieldEffects {
     ...
     */
    @IBInspectable dynamic open var activeBorderColor: UIColor = ColorKit.themeColor {
        didSet {
            updateBorder()
            updateBackground()
            updatePlaceholder()
    ...
    /**
     ...
     This property applies a color to the edges of the control. The default value for this property is a clear color.
     */
    @IBInspectable dynamic open var inactiveBorderColor: UIColor = .groupTableViewBackground {
        didSet {
            updateBorder()
            updateBackground()
            updatePlaceholder()
     ...
     */
    @IBInspectable dynamic open var activeBackgroundColor: UIColor = UIColor.groupTableViewBackground {
        didSet {
            updateBackground()
        }
    }
