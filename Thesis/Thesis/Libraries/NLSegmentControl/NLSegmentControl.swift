...
// MARK: - Public Properties
    ...
    public var selectionIndicatorColor: UIColor = .label {
        didSet {
...
fileprivate extension UIButton {
    ...
    func nl_setImagePosition(position: NLSegmentControl.SegmentImagePosition, spacing: CGFloat) {
        ...
        let labelSize = NSString(string: titleLabel?.text ?? "").size(withAttributes: [NSAttributedString.Key.font: titleLabel?.font ?? UIFont.systemFont(ofSize: 12)])
